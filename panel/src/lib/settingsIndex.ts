...
export const SETTINGS_INDEX: SettingsEntry[] = [
    ...
    { page: 'gateway', label: 'Routing mode and file access', where: 'Infrastructure → Gateway', keywords: ['routing', 'gateway', 'ip port', 'beam', 'sftp'] },
    { page: 'gateway', label: 'Hoster domains and route limits', where: 'Infrastructure → Gateway', keywords: ['domain', 'subdomain', 'wildcard', 'cname', 'custom domain', 'route'] },
    { page: 'gateway', label: 'Automatic DNS & certificates', where: 'Infrastructure → Gateway', keywords: ['dns', 'zone', 'cloudflare', 'acme', 'certificate', 'tls', 'lets encrypt', 'token'] },
    { page: 'gateway', label: 'DNS check', where: 'Infrastructure → Gateway', keywords: ['dns', 'check', 'records', 'resolve', 'verify'] },
