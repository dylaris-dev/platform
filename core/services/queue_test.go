...
func (f *fakeACLHandshakeStore) GetNodePublicKeys(int) (string, string, error) {
	return "", "", nil
}
func (f *fakeACLHandshakeStore) SetNodePublicKeyIfUnchanged(int, string, string, string) (bool, error) {
	return true, nil
}
